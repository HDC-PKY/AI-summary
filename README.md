...
- 정책 스키마는 `src/core/data_pipeline/policies/schema/smart_folder_policy.schema.json`, 예시는 `src/core/data_pipeline/policies/examples/smart_folder_policy_sample.json`에서 확인할 수 있습니다.
